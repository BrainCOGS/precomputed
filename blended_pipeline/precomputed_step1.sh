...
#SBATCH -o logs/precomputed_step1_%A_%a.out        # STDOUT
#SBATCH -e logs/precomputed_step1_%A_%a.err        # STDERR
...
xvfb-run -d python make_precomputed_blended.py step1 ${viz_dir}
