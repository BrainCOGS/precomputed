...
viz_dir=/jukebox/LightSheetData/lightserv/oostland/MO_May2021_Tsc1_part1/MO_May2021_Tsc1_part1-520/imaging_request_1/viz/raw_atlas_test6
...
# echo $OUT3
OUT3=$(sbatch --parsable --export=ALL,raw_atlas_dir=${raw_atlas_dir},viz_dir=${viz_dir},z_step_microns=${z_step_microns} precomputed_atlas_step3.sh) 
echo $OUT3
