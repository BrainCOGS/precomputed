...
#SBATCH -o logs/step1_logs/precomputed_%A_step1_%a.out        # STDOUT
#SBATCH -e logs/step1_logs/precomputed_%A_step1_%a.err        # STDERR
...
xvfb-run -d python make_precomputed_stitched_data.py step1 ${viz_dir}
