...
#SBATCH -o logs/step2_logs/precomputed_%A_step2_%a.out        # STDOUT
#SBATCH -e logs/step2_logs/precomputed_%A_step2_%a.err        # STDERR
...
xvfb-run -d python make_precomputed_stitched_data.py step2 ${viz_dir}
